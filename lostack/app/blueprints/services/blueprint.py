...
def register_blueprint(app:Flask) -> Blueprint:
    ...
    def service_edit(service_id):
        ...
        if request.method == "GET":
            populate_package_entry_form(form, service)
        ...
        if form.validate_on_submit():
            ...
            service.lostack_middleware_enabled = form.lostack_middleware_enabled.data
            service.sablier_middleware_enabled = form.sablier_middleware_enabled.data
            service.access_groups = form.access_groups.data
    ...
    def service_toggle_access_control(service_id):
        ...
        try:
            service.lostack_middleware_enabled = not service.lostack_middleware_enabled
            current_app.db.session.commit()
    ...
    def service_toggle_autostart(service_id):
        ...
        try:
            service.sablier_middleware_enabled = not service.sablier_middleware_enabled
            current_app.db.session.commit()
